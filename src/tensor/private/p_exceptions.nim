...
type
  ...
  TensorLayoutError* = ref object of ValueError
    ## Raised when tensor layout is not contigous.

  IncompatibleRankError* = ref object of ValueError
